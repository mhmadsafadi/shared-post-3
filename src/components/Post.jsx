...
import { Button, Card, Dropdown, Image, Space } from "antd";
import { DownOutlined, UserOutlined,MoreOutlined, ShareAltOutlined, EditOutlined, DeleteOutlined } from '@ant-design/icons';

const Post = ({clickEditPost, clickDeletePost, clickSharePost}) => {
  ...
  return (
    <div className="post-card-home">
      <Card>
        ...
        <Button type="link" className="share-btn" onClick={handleSharePost}>
          <ShareAltOutlined />
        </Button>
      </Card>
    </div>
